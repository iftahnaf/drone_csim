  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"interception_v15\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(interception_v15_M, (NULL));
        interception_v15_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(interception_v15_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(interception_v15_M)
                == (NULL)) || rtmGetStopRequested(interception_v15_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(interception_v15_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
