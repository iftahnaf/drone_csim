...
// Conversions between SL_Bus_interception_v15_geometry_msgs_Point and geometry_msgs::Point
...
// Conversions between SL_Bus_interception_v15_geometry_msgs_Pose and geometry_msgs::Pose
...
// Conversions between SL_Bus_interception_v15_geometry_msgs_PoseStamped and geometry_msgs::PoseStamped
...
// Conversions between SL_Bus_interception_v15_geometry_msgs_Quaternion and geometry_msgs::Quaternion
...
// Conversions between SL_Bus_interception_v15_geometry_msgs_Twist and geometry_msgs::Twist
...
// Conversions between SL_Bus_interception_v15_geometry_msgs_TwistStamped and geometry_msgs::TwistStamped
...
// Conversions between SL_Bus_interception_v15_geometry_msgs_Vector3 and geometry_msgs::Vector3
...
// Conversions between SL_Bus_interception_v15_mavros_msgs_AttitudeTarget and mavros_msgs::AttitudeTarget

void convertFromBus(mavros_msgs::AttitudeTarget* msgPtr, SL_Bus_interception_v15_mavros_msgs_AttitudeTarget const* busPtr)
{
  const std::string rosMessageType("mavros_msgs/AttitudeTarget");

  convertFromBus(&msgPtr->body_rate, &busPtr->BodyRate);
  convertFromBus(&msgPtr->header, &busPtr->Header);
  convertFromBus(&msgPtr->orientation, &busPtr->Orientation);
  msgPtr->thrust =  busPtr->Thrust;
...
void convertToBus(SL_Bus_interception_v15_mavros_msgs_AttitudeTarget* busPtr, mavros_msgs::AttitudeTarget const* msgPtr)
{
  ...
  convertToBus(&busPtr->BodyRate, &msgPtr->body_rate);
  convertToBus(&busPtr->Header, &msgPtr->header);
  convertToBus(&busPtr->Orientation, &msgPtr->orientation);
  busPtr->Thrust =  msgPtr->thrust;
  busPtr->TypeMask =  msgPtr->type_mask;
}


// Conversions between SL_Bus_interception_v15_mavros_msgs_ParamValue and mavros_msgs::ParamValue

void convertFromBus(mavros_msgs::ParamValue* msgPtr, SL_Bus_interception_v15_mavros_msgs_ParamValue const* busPtr)
{
  const std::string rosMessageType("mavros_msgs/ParamValue");

  msgPtr->integer = (int64_t) busPtr->Integer;
...
void convertToBus(SL_Bus_interception_v15_mavros_msgs_ParamValue* busPtr, mavros_msgs::ParamValue const* msgPtr)
{
  ...
  busPtr->Integer = (real_T) msgPtr->integer;
  busPtr->Real =  msgPtr->real;
}


// Conversions between SL_Bus_interception_v15_ros_time_Time and ros::Time
...
// Conversions between SL_Bus_interception_v15_std_msgs_Header and std_msgs::Header
